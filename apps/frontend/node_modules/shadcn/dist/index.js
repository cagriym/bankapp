#!/usr/bin/env node
import { a as a$1 } from './chunk-UBC2EX4X.js';
import { N, u, v, R, r, a, x as x$1, o, h, p, s, i, P, S, e, f, c, d, g, q, w, m, O, H as H$1, G, V, T, W, t, j, Z as Z$1, y, aa, X as X$1, ca, ba, l, k, z as z$1, A as A$1, Q as Q$1, n, b } from './chunk-BJAN3BBB.js';
...
var A="1";var D="3";var ne="5",Me="6",jt="7";var H="13";async function Et(e){let t={};if(!Z.existsSync(e.cwd)||!Z.existsSync(x__default.resolve(e.cwd,"package.json")))return t[A]=!0,{errors:t,projectInfo:null};let r$1=s("Preflight checks.",{silent:e.silent}).start();Z.existsSync(x__default.resolve(e.cwd,"components.json"))&&!e.force&&(r$1?.fail(),r.break(),r.error(`A ${a.info("components.json")} file already exists at ${a.info(e.cwd)}.
...
Once configured, you can use the cli to add components.`),r.break(),process.exit(1)),i?.succeed(`Verifying framework. Found ${a.info(o$1.framework.label)}.`);let n="Validating Tailwind CSS.";o$1.tailwindVersion==="v4"&&(n=`Validating Tailwind CSS config. Found ${a.info("v4")}.`);let a$1=s(n,{silent:e.silent}).start();o$1.tailwindVersion==="v3"&&(!o$1?.tailwindConfigFile||!o$1?.tailwindCssFile)?(t[ne]=!0,a$1?.fail()):o$1.tailwindVersion==="v4"&&!o$1?.tailwindCssFile?(t[ne]=!0,a$1?.fail()):o$1.tailwindVersion?a$1?.succeed():(t[ne]=!0,a$1?.fail());let s$1=s("Validating import alias.",{silent:e.silent}).start();return o$1?.aliasPrefix?s$1?.succeed():(t[Me]=!0,s$1?.fail()),Object.keys(t).length>0&&(t[ne]&&(r.break(),r.error(`No Tailwind CSS configuration found at ${a.info(e.cwd)}.`),r.error("It is likely you do not have Tailwind CSS installed or have an invalid configuration."),r.error("Install Tailwind CSS then try again."),o$1?.framework.links.tailwind&&r.error(`Visit ${a.info(o$1?.framework.links.tailwind)} to get started.`)),t[Me]&&(r.break(),r.error("No import alias found in your tsconfig.json file."),o$1?.framework.links.installation&&r.error(`Visit ${a.info(o$1?.framework.links.installation)} to learn how to set an import alias.`)),r.break(),process.exit(1)),{errors:t,projectInfo:o$1}}function $t(e,t){if(e.includes("\0"))return !1;let r;try{r=e;let u="";for(;r!==u&&r.includes("%");)u=r,r=decodeURIComponent(r);}catch{return !1}let i=x__default.normalize(r.replace(/\\/g,"/")),o=x__default.normalize(t),n=u=>u.replace(/\[\.\.\..*?\]/g,"").includes("..");if(n(i)||n(r)||n(e))return !1;let a=u=>u.replace(/\[\.\.\..*?\]/g,""),s=a(e),c=a(r);if([/\.\.[\/\\]/,/[\/\\]\.\./,/\.\./,/\.\.%/,/\x00/,/[\x01-\x1f]/].some(u=>u.test(s)||u.test(c))||(e.includes("~")||r.includes("~"))&&(e.includes("../")||r.includes("../")))return !1;if(/^[a-zA-Z]:[\/\\]/.test(r))return process.platform==="win32"?r.toLowerCase().startsWith(t.toLowerCase()):!1;if(x__default.isAbsolute(i))return i.startsWith(o+x__default.sep);let m=x__default.resolve(o,i);return m.startsWith(o+x__default.sep)||m===o}async function We(e,t,r){if(!t.resolvedPaths.tailwindCss||!e||Object.keys(e).length===0)return;r={silent:!1,...r};let i=t.resolvedPaths.tailwindCss,o=x__default.relative(t.resolvedPaths.cwd,i),n=s(`Updating ${a.info(o)}`,{silent:r.silent}).start(),a$1=await promises.readFile(i,"utf8"),s$1=await br(a$1,e);await promises.writeFile(i,s$1,"utf8"),n.succeed();}async function br(e,t){let r=[Sr(t)],o=(await S$1(r).process(e,{from:void 0})).css;return o=o.replace(/\/\* ---break--- \*\//g,""),o=o.replace(/(\n\s*\n)+/g,`
...
`),a$1.succeed("Updated package.json."),await X(["radix-ui"],[],e,{silent:!1});}else a$1.succeed("No packages found in source files.");}catch{a$1.fail("Failed to update package.json"),r.warn("You may need to manually replace @radix-ui/react-* packages with radix-ui");}}async function ao(e){let t=/import\s+(?:(type)\s+)?(?:\*\s+as\s+(\w+)|{([^}]+)})\s+from\s+(["'])@radix-ui\/react-([^"']+)\4(;?)/g,r=[],i=[],o=[],n='"',a=!1,s=e,c;for(;(c=t.exec(e))!==null;){let[y,R,g,b,k,v,E]=c;if(v==="icons"||v.startsWith("icons/"))continue;i.push(y),i.length===1&&(n=k,a=E===";"),o.push(`@radix-ui/react-${v}`);let j=!!R;if(g){let _=no(v);r.push({name:_,alias:g,isType:j});}else b&&so(b,j,r,v);}if(r.length===0)return {content:e,replacedPackages:[]};let l=r.filter((y,R,g)=>R===g.findIndex(b=>b.name===y.name&&b.alias===y.alias&&b.isType===y.isType)),m=`import { ${l.map(y=>{let R=y.isType?"type ":"";return y.alias?`${R}${y.name} as ${y.alias}`:`${R}${y.name}`}).join(", ")} } from ${n}radix-ui${n}${a?";":""}`;s=i.reduce((y,R,g)=>y.replace(R,g===0?m:""),s),s=s.replace(/\n\s*\n\s*\n/g,`
